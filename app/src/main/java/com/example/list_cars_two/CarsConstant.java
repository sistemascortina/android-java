...
public class CarsConstant {
    public static final String carsDB = "CarsDB";
    public static final String carsTable = "Cars";
    public static final String carsName = "Name";
    public static final String carsPrice = "Price";
    public static final String carsYear = "Year";
    public static final String carsBrand = "Brand";
